Write-Host "=== 虚幻引擎MOD管理器 v1.8.0 安装程序构建 ===" -ForegroundColor Green
...
# 清理并复制最新编译的Release文件
$stagingDir = "installer_output\UEModManager_v1.8.0"
...
if ($process.ExitCode -eq 0) {
    $installer = "installer_output\UEModManager_v1.8.0_Setup_Clean.exe"
