...
OutputBaseFilename=UEModManager_v1.7.37_Setup_Clean
...
[Files]
; 递归复制发布目录全部文件
Source: "installer_output\UEModManager_v1.7.37\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
[Icons]
